  ...
  <div class="col">
    <div class="card text-center h-100 w-50">
      ...
      <div class="card-body">
		...
		<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@Ahstanga">예약하기</button>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card text-center h-100 w-50" >
      ...
      <div class="card-body">
		...
		<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">예약하기</button>
      </div>
    </div>
  </div>
  <div class="col">
